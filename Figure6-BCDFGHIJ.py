...
#%% D1 vs D2 vector length cross limbs - Figure 6B
group = 'CT'
...
plt.savefig(f'{figpath}Figure6-B.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% D1 vs D2 vector length cross limbs - Figure 6F
group = 'PD'
hl_psi = psi_trimed.loc[(psi_trimed['group_id']==group)]
hl_psi_tagging = hl_psi.loc[(hl_psi['tagging']==1)]
n1 = len(hl_psi_tagging.loc[(hl_psi_tagging['strain']=='D1') &\
...
plt.savefig(f'{figpath}Figure6-E.pdf',dpi=300,bbox_inches='tight', transparent=True)
...
#%% D1 vs D2 vector angle cross limbs - Figure 4C
...
plt.savefig(f'{figpath}Figure6-C.pdf',dpi=300,bbox_inches='tight', transparent=True)
...
plt.savefig(f'{figpath}Figure6-F.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% movement start encoding - d1 vs d2 - Figure 6I
#
...
plt.savefig(f'{figpath}Figure6-G.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% movement start encoding - d1 vs d2 - Figure 6J
#
from scipy.stats import ttest_ind
window = [-10, 10] # in second
binsize = 0.02 # bin size 20ms
...
plt.savefig(f'{figpath}Figure6-H.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% movement stop encoding - d1 vs d2 - Figure 6 – Figure Supplement 1-B
#
from scipy.stats import ttest_ind
window = [-10, 10] # in second
binsize = 0.02 # bin size 20ms
...
plt.savefig(f'{figpath}Figure S3-B.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% movement stop encoding - d1 vs d2 - Figure 6 – Figure Supplement 1-C
#
from scipy.stats import ttest_ind
window = [-10, 10] # in second
binsize = 0.02 # bin size 20ms
...
plt.savefig(f'{figpath}Figure S3-C.pdf',dpi=300,bbox_inches='tight', transparent=True)
#%% movement speed encoding - d1 vs d2 - Figure 6 – Figure Supplement 1-D
...
plt.savefig(f'{figpath}Figure S3-D.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% movement speed encoding - d1 vs d2 - Figure 6 – Figure Supplement 1-E
all_binning_fr_trimed = zscore(all_binning_fr_trimed, axis=0)
...
plt.savefig(f'{figpath}Figure S3-E.pdf',dpi=300,bbox_inches='tight', transparent=True)

#%% plot the firing rate of D1 and D2
# new Figure 6D,H
import seaborn as sns
group = 'PD'
limb = 'lf'
...
#plt.savefig(f'{figpath}Figure6-DH.pdf',dpi=300,bbox_inches='tight', transparent=True)