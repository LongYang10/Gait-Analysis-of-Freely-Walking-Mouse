...
#%% D1 vs D2 vector length cross limbs - Figure 6B,E
group = 'CT'
...
#%% D1 vs D2 vector angle cross limbs - Figure 4C,F
...
#%% movement start encoding - d1 vs d2 - Figure 6G,H,Figure S3-B,C
#
...
#%% movement start encoding - d1 vs d2 - Figure S3-B,C
#
from scipy.stats import ttest_ind
window = [-10, 10] # in second
binsize = 0.02 # bin size 20ms
...
#%% movement speed encoding - d1 vs d2 - Figure S3-D,E
