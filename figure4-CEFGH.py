...
#%% D1 vs D2 vector length cross limbs - Figure 4E
group = 'HL'
hl_psi = psi_trimed.loc[(psi_trimed['group_id']==group)]
hl_psi_tagging = hl_psi.loc[(hl_psi['tagging']==1)]
...
#%% D1 vs D2 vector angle cross limbs - Figure 4F
...
#%% movement start encoding - d1 vs d2 - Figure 4G
#
...
#%% movement speed encoding - d1 vs d2 - Figure 4H
